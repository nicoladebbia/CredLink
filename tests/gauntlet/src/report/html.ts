...
class HTMLReportGenerator {
  ...
  constructor(config: Partial<ReportConfig> = {}) {
    this.config = {
      ...
      logo_url: 'https://credlink.com/logo.png',
          ...
          tableRows.push(`
            <tr>
              ...
              ${transforms.map(transform => {
                ...
                const statusIcon = result.verdict_remote === 'PASS' ? '✓' : '✗';
        ...
        <div class="container">
          <header class="header">
            ...
            <div class="subtitle">
              ...
              ${summary.total_tests.toLocaleString()} tests • 
              ${isP0 ? '🚨 P0 INCIDENT' : '✅ OPERATIONAL'}
            </div>
          </header>

          ${isP0 ? 
            '<div class="p0-banner">🚨 P0 INCIDENT: Remote survival below 99.9% threshold</div>' :
            '<div class="success-banner">✅ All systems operational: Remote survival ≥ 99.9%</div>'
          }
