...
async function verifyHandler(request, reply) {
    ...
    try {
        ...
        if (error && typeof error === 'object' && 'code' in error && 'message' in error) {
            ...
            verificationError = new VerificationError('NETWORK_ERROR', error instanceof Error ? error.message : 'Unknown error');
        }
 ...
 */
async function trustRootsHandler(request, reply) {
