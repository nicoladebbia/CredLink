 ...
 */
export function buildLicenseAssertion(metadata: ProviderAssetMetadata): LicenseAssertion {
 ...
 */
export function buildReleaseAssertion(metadata: ProviderAssetMetadata): ReleaseAssertion {
 ...
 */
export function buildProviderManifestAssertion(
 ...
 */
export function generateManifestHash(assertion: ProviderManifestAssertion): string {
  if (!assertion) {
 ...
 */
export function getManifestStoragePath(manifestHash: string): string {
 ...
 */
export function validateLicenseAssertion(assertion: LicenseAssertion): ValidationResult {
  const errors: string[] = [];
 ...
 */
export function validateManifestAssertion(assertion: ProviderManifestAssertion): ValidationResult {
  const errors: string[] = [];
  const warnings: string[] = [];
 ...
 */
function getProviderName(provider: LicenseProvider): string {
  const names = {
    getty: 'Getty Images',
    ap: 'Associated Press',
 ...
 */
export function formatLicenseForBadge(assertion: LicenseAssertion): string {
  const parts = [
...
function sanitizeString(input?: string): string | undefined {
