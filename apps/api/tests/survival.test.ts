...
describe('Survival Tests - Day 6-8', () => {
  ...
  describe('Compression Tests', () => {
    it('should survive JPEG quality reduction to 80%', async () => {
      ...
      const compressed = await sharp(embedded)
        .withMetadata() // Preserve metadata during transformation
        .jpeg({ quality: 80 })
        .toBuffer();
    ...
    it('should survive JPEG quality reduction to 60%', async () => {
      ...
      const compressed = await sharp(embedded).withMetadata()
        .jpeg({ quality: 60 })
        .toBuffer();
  ...
  describe('Format Conversion Tests', () => {
    it('should survive JPEG to PNG conversion', async () => {
      ...
      const converted = await sharp(embedded).withMetadata()
        .png()
        .toBuffer();
  ...
  describe('Resizing Tests', () => {
    it('should survive 50% downscale', async () => {
      ...
      const metadata = await sharp(embedded).withMetadata().metadata();
      const resized = await sharp(embedded).withMetadata()
  ...
  describe('Cropping Tests', () => {
    it('should survive center crop (80%)', async () => {
      ...
      const cropped = await sharp(embedded).withMetadata()
        .extract({
  ...
  describe('Rotation Tests', () => {
    it('should survive 90° rotation', async () => {
      ...
      const rotated = await sharp(embedded).withMetadata()
        .rotate(90)
        .withMetadata() // Preserve metadata
        .toBuffer();
    ...
    it('should survive flip horizontal', async () => {
      ...
      const flipped = await sharp(embedded).withMetadata()
        .flop()
        .withMetadata() // Preserve metadata
        .toBuffer();
  ...
  describe('Filter and Effect Tests', () => {
    it('should survive grayscale conversion', async () => {
      ...
      const grayscale = await sharp(embedded).withMetadata()
        .grayscale()
        .withMetadata() // Preserve metadata
        .toBuffer();
    ...
    it('should survive blur filter', async () => {
      ...
      const blurred = await sharp(embedded).withMetadata()
        .blur(2)
        .withMetadata() // Preserve metadata
        .toBuffer();
    ...
    it('should survive sharpen filter', async () => {
      ...
      const sharpened = await sharp(embedded).withMetadata()
        .sharpen()
        .withMetadata() // Preserve metadata
        .toBuffer();
  ...
  describe('Combined Transformation Tests', () => {
    it('should survive resize + compression', async () => {
      ...
      const transformed = await sharp(embedded).withMetadata()
        .resize(50, 50)
        .withMetadata() // Preserve metadata
        .jpeg({ quality: 70 })
        .toBuffer();
