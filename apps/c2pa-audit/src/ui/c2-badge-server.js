...
export class C2LicenseBadge {
     ...
     */
    updateWithVerification(response) {
        const state = {
     ...
     */
    static generateForAsset(_assetUrl, config) {
 ...
 */
export function initializeC2Badges() {
 ...
 */
export function generateBadgeHTML(_assetUrl, verificationResponse, config) {
    const badge = new C2LicenseBadge(config);
...
//# sourceMappingURL=c2-badge-server.js.map