...
export { LicenseMetadataEncoder } from './core/license-metadata.js';
// Verify events system with webhook security
export { VerifyEventSystem } from './core/verify-events.js';
// Server API for verification and enforcement
export { LicenseEnforcementAPI } from './api/license-enforcement.js';
// UI components for badge display (server-compatible)
export { C2LicenseBadge, initializeC2Badges, generateBadgeHTML, generateBadgeStyles } from './ui/c2-badge-server.js';
// CMS/CDN integration adapters
export { WordPressLicenseAdapter as WordPress, ShopifyLicenseAdapter as Shopify, CloudflareWorkerAdapter as CloudflareWorker } from './integrations/cms-adapters.js';
// Import for internal use
import { LicenseMetadataEncoder as LicenseMetadataEncoderInternal } from './core/license-metadata.js';
import { VerifyEventSystem as VerifyEventSystemInternal } from './core/verify-events.js';
import { LicenseEnforcementAPI as LicenseEnforcementAPIInternal } from './api/license-enforcement.js';
import { initializeC2Badges as initializeC2BadgesInternal } from './ui/c2-badge-server.js';
/**
...
export class LicensedContentEnforcement {
     ...
     */
    validateLicenseAssertion(assertion) {
