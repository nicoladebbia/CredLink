...
export class JSONCanonicalizer {
    static MAX_NESTING_DEPTH = 100;
    static MAX_STRING_LENGTH = 1000000; // 1MB
    static MAX_ARRAY_LENGTH = 10000;
    static MAX_OBJECT_KEYS = 10000;
    /**
     ...
     */
    static canonicalizeValue(value, depth) {
        ...
        if (typeof value === 'object' && value !== null) {
            return this.canonicalizeObject(value, depth + 1);
        }
     ...
     */
    static convertScientificToDecimal(scientific) {
     ...
     */
    static canonicalizeArray(arr, depth) {
     ...
     */
    static canonicalizeObject(obj, depth) {
     ...
     */
    static validateCanonicalized(original, canonicalized) {
        try {
     ...
     */
    static generateHashURI(data, algorithm = 'sha256') {
     ...
     */
    static compareCanonicalized(a, b) {
     ...
     */
    static isCanonicalizable(value) {
        try {
     ...
     */
    static getCanonicalizedSize(value) {
     ...
     */
    static deepCloneAndCanonicalize(value) {
