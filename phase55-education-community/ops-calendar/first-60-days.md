...
gh repo edit Nickiller04/c2-concierge --enable-discussions
...
GH_DISCUSSIONS=$(gh api repos/Nickiller04/c2-concierge/discussions --jq '.total_count')
...
COMMUNITY_REPOS=$(gh api search/repos q="c2-concierge+in:readme" --jq '.total_count')
