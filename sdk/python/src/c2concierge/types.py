"""
Core types and models for the C2 Concierge SDK
...
class ClientConfig(BaseModel):
    """Configuration for the C2 Concierge client"""
    api_key: str = Field(..., description="API key for authentication")
    base_url: str = Field(default="https://api.c2concierge.com/v1", description="Base URL for the API")
...
class C2ConciergeError(Exception):
    """Base class for all C2 Concierge errors"""
...
class AuthError(C2ConciergeError):
    ...
    def __init__(self, message: str = "Authentication failed", **kwargs):
        super().__init__(
            ...
            docs_url="https://docs.c2concierge.com/api/errors#auth_error",
            **kwargs
        )
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            ...
            docs_url="https://docs.c2concierge.com/api/errors#rate_limit_error",
            **kwargs
        )
...
class ConflictError(C2ConciergeError):
    ...
    def __init__(self, message: str = "Request conflicts with current state", **kwargs):
        super().__init__(
            ...
            docs_url="https://docs.c2concierge.com/api/errors#conflict_error",
            **kwargs
        )
...
class ValidationError(C2ConciergeError):
    ...
    def __init__(self, message: str = "Request data failed validation", **kwargs):
        super().__init__(
            ...
            docs_url="https://docs.c2concierge.com/api/errors#validation_error",
            **kwargs
        )
...
class ServerError(C2ConciergeError):
    ...
    def __init__(self, message: str = "Server encountered an unexpected error", **kwargs):
        super().__init__(
            ...
            docs_url="https://docs.c2concierge.com/api/errors#server_error",
            **kwargs
        )
...
class NetworkError(C2ConciergeError):
    ...
    def __init__(self, message: str = "Network connectivity issue encountered", **kwargs):
        super().__init__(
            ...
            docs_url="https://docs.c2concierge.com/api/errors#network_error",
            **kwargs
        )
