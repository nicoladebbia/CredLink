...
const (
	Version    = "2.0.0"
	UserAgent  = "c2c-sdk/go/" + Version
	DefaultURL = "https://api.c2concierge.com/v1"
)
...
// Error is the base interface for all C2 Concierge errors
...
func NewBaseError(message, code string, statusCode int) *BaseError {
	return &BaseError{
		...
		docsURL:    "https://docs.c2concierge.com/api/errors#" + strings.ToLower(code),
	}
}
