...
let ProofStorage: any = null;
try {
  ProofStorage = require('@credlink/storage').ProofStorage;
} catch {
  // ProofStorage not available, will be null
}
...
export class C2PAService {
  ...
  constructor(options: { useRealC2PA?: boolean; proofStorage?: any } = {}) {
    ...
    this.proofStorage = options.proofStorage || (ProofStorage ? new ProofStorage() : null);
