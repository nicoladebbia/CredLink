...
class WordPressThemeTester {
     ...
     */
    async testThemeScenario(theme, scenario) {
     ...
     */
    async installTheme(page, theme_slug) {
     ...
     */
    async createTestContent(page, scenario) {
     ...
     */
    async attachImageToPost(page, post_id, image_id) {
     ...
     */
    async checkPageInjection(page, post_id, result) {
        // Visit the post
     ...
     */
    async testUninstallSafety(page, result) {
     ...
     * Save test artifacts
     */
    async saveArtifacts(theme, scenario, result) {
        const artifact_data = {
            theme: theme.name,
            scenario,
...
//# sourceMappingURL=wp-test.js.map